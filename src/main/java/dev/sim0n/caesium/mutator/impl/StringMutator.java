...
public class StringMutator extends ClassMutator {
    ...
    public void handle(ClassWrapper wrapper) {
        ...
        bsmHandle = new Handle(H_INVOKESTATIC, target.name, bsmName, bsmSig, false);
                        ...
                        if (insn.getOpcode() == LDC) {
                            ...
                            if (ldc.cst instanceof String) {
                                ...
                                if (random.nextBoolean()) {
                                    ...
                                    newInstructions.add(new LdcInsnNode((long) key1));
